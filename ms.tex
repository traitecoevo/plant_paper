...
% TODO: I don't have the background to write it, but (at the risk of
% making a long paragraph even longer) is it worth adding something
% saying something about how we'd expect size structure to be
% particularly important for plants because they grow up through a
% canopy?  Perhaps not useful?
...
include size-structured demography \citep{Cramer-2001, Sitch-2003,
  Kelley-2013,Dekauwe-2014}.  During the 1980s, size-structured
...
demography \citep[e.g.][]{Woodward-1995,Haxeltine-1996}. While the
importance of size-structure is starting again to be recognised
\citep{Moorcroft-2001, Falster-2011, Dekauwe-2014}, all but a couple
\citep[e.g.][]{Moorcroft-2001, Smith-2014} of the most popular,
...
disturbance regime.
% TODO: the first sentence reads weirdly to me: the paragraph now says
% "we introduce our model / other models are like X / our model is
% also like X" I'm not sure what the key point that is being driven at
% here, either.
%
% TODO: I've reordered it and changed the emphasis here.  Can you
% check that you agree and if so add a reference.
...
studied in detail.  In {\plant} it is possible to grow plants in
isolation, in patches of competing plants and in disturbance-driven
metapopulations. The package is thus designed to sit in the middle
ground between a large-scale coupled simulation model and simple
abstract theoretical device. 
% TODO: Consider moving to the conclusion?
As examples, we expect the package will prove useful for investigating
how morphological and physiological traits influence growth rate and
shade tolerance, and emergent phenomena such as multi-species
self-thinning, successional transitions and age-related changes in
vegetation productivity.

% TODO: they aren't actually available within plant yet, and
% realistically won't be by the updated.  I've added a placeholder
% that contains appropriate links.
...
(see Appendices), and updated versions of technical documents are also
...
Fig. \ref{fig:patch}c). Moreover, predictions are for a frequency distribution 
of states across the landscape. Similarly, the distributions of  abundance and growth rate
observed in large forest  plots \citep[e.g.][]{Muller-2006, Coomes-2007} may
can be modelled as  emergent phenomena, where variety of patch-level
relationships combine to  produce  an emergent average across all patches
(Fig. \ref{fig:emergent}, see more detail in Appendix \ref{sec:emergent}). As such,
size-and patch- structured models may be more suitable for comparing with 
satellite and survey data, than unstructured models representing the world as 
homogeneous green slime \citep{Moorcroft-2001,Moorcroft-2001}.  
