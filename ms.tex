...
\usepackage[verbose,tmargin=2cm,bmargin=2cm,lmargin=3.5cm,rmargin=2.5cm]{geometry}
...
\hypersetup{breaklinks=true,
            ...
            pdftitle={\texttt{TREE}: A package for modelling plant TRait Ecology and Evolution},
            colorlinks=true,
            citecolor=grey,
            urlcolor=grey,
            linkcolor=grey,
...
\noindent A manuscript in consideration as a research paper for publication in MEE
as part of the Special Feature \emph{Demography beyond the Population}.
