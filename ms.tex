...
% TODO: I'm a bit concerned that while we know that this is possible,
% it's not that well developed and does require compiling a new
% version of plant.  So it's not that _usefully_ extendable.  On the
% other hand, the population of users who will do this is not very
% large.  It might be possible to allow runtime linkage though if I
% push a little more of the cpp code into headers and do some tweaking
% in RcppR6...
