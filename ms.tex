...
% TODO[RGF]: Is this new acronym needed?  It's not really the place of
% this contribution to define a new class of models, and given that
% this all comes from a response to a reviewer, IMO it bends the paper
% to be too much like a response to the reviewer.
...
%% TODO[RGF]: I think that this needs softening.  Users can't really
%% add new models; that has to be done by *developers*, really
%% (because of the design the models are compiled into the package.
...
% TODO[RGF]: I think that this section should be reduced considerably,
% ideally into a single paragraph.  The first three "paragraphs"
% should be largely retained, shrinking the third.
...
detail.
% From here down can be largely dropped I think
